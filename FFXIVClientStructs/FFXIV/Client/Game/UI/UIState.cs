...
public unsafe partial struct UIState
{
    ...
    [FieldOffset(0x1208)] public Revive Revive; // 6.4
    [FieldOffset(0x14A0)] public Inspect Inspect;
    [FieldOffset(0x14A0)] public Telepo Telepo;
    [FieldOffset(0x14F8)] public Cabinet Cabinet;
    [FieldOffset(0x1540)] public Achievement Achievement;
    ...
    [FieldOffset(0x2AF8)] public AreaInstance AreaInstance; // at vtbl - 0x10
    ...
    [FieldOffset(0x16AB6)] public fixed byte ChocoboTaxiStandsBitmask[312 >> 3];

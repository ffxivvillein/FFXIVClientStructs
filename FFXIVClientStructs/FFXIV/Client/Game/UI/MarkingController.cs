...
[StructLayout(LayoutKind.Explicit, Size = 0x2B0)] // 6.4
public unsafe partial struct MarkingController
{
	...
	[FieldOffset(0xE8)] public fixed long MarkerTimeArray[17]; //(1000 * QueryPerformanceCounter / QueryPerformanceFrequency)

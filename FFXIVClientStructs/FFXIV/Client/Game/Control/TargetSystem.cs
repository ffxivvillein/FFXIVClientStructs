...
[StructLayout(LayoutKind.Explicit, Size = 0x52F0)] // 6.4
public unsafe partial struct TargetSystem
{
    ...
    [FieldOffset(0x1A18)] public GameObjectArray ObjectFilterArray1;    // 6.4
    [FieldOffset(0x2CD8)] public GameObjectArray ObjectFilterArray2;    // 6.4
    [FieldOffset(0x3F98)] public GameObjectArray ObjectFilterArray3;    // 6.4
